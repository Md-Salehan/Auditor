    ...
    <footer className="bg-black text-white pt-xl pb-lg px-margin rounded-t-[64px] relative z-20">
      <div className="max-w-[1728px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-xl mb-xl">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="font-body-md text-white/50 w-full">
              The operating system for enterprise accessibility compliance.
              Empowering teams through intelligent testing and monitoring.{" "}
            </p>
          ...
          {/* Navigation Columns */}
          <div>
            <h4 className="font-label text-white mb-6 uppercase tracking-widest text-[10px]">
              Product
            </h4>
            <ul className="flex flex-col gap-4">
              <li>
                <a
                  className="font-body-md text-white/60 hover:text-white transition-colors"
                  href="#"
                >
                  Platform
                </a>
        ...
        <div className="pt-md border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-label text-[11px] text-white/40">
            © 2024 Lumio Inc. All rights reserved.
          </p>
          <div className="flex gap-8">
            <a
              className="font-label text-[11px] text-white/40 hover:text-white transition-colors"
              href="#"
            >
              Privacy Policy
            </a>
